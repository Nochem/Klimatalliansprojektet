 function tonCO2(nbr) {
    ...
    function update(nbr, amount, emission, convFac) {
        ...
        if (!isNaN(ton) && ton > 0) {
            ...
            document.getElementsByName("tonCO[]")[nbr].innerHTML = round(ton, 4);
            document.getElementsByName("ton[]")[nbr].value = round(ton, 4);
        } else {

            document.getElementsByName("tonCO[]")[nbr].innerHTML = "0";
            document.getElementsByName("ton[]")[nbr].innerHTML = "0";
        }
    }
