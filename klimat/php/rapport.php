    ...
    <div id="wrapper">
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <form>
                    <input id="modalInputReportName" required='' type='text'>
                    ...
                    <br>
                    <input id="modalInputName" required='' type='text'>
                    <label alt='Ditt Namn' placeholder='Skriv ditt namn'></label>
                    <input type="checkbox" name="vehicle" value="FärdigRapport" unchecked> Färdig Rapport
                    <br>
                    <br>
                    <button id = "saveCheck" class = "menubutton flatbutton savebutton" style="left: 5px">
                        Spara
                    </button>
