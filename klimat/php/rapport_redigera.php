...
<div id="wrapper">
    ...
    <div id="content">
		...
		<tbody>';
            ...
            echo '<td> <input class="inputbox" name="producedSolarHeat" type="text" value = "'.$otherplacesrow['ProducedSolarElectricity'].'"> </td>';
            echo '<td>
            ...
            echo '<td> <input class="inputbox" name="producedSolarElectrity" type="text" value = "'.$otherplacesrow['ProducedSolarHeat'].'"> </td>';
            echo '<td>
			<p style="margin:5px">MWh</p>
		 </td>';
            echo '</tr>
